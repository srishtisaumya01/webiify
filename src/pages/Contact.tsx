  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="animate-slide-in-left">
              ...
              <p className="text-foreground/70 mb-8 animate-fade-in animate-delay-100">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4 animate-fade-in animate-delay-200 hover:translate-x-2 transition-transform duration-300">
                  <div className="flex-shrink-0 bg-webiify-purple/10 rounded-full p-3 animate-pulse">
                ...
                <div className="flex items-start space-x-4 animate-fade-in animate-delay-300 hover:translate-x-2 transition-transform duration-300">
                  <div className="flex-shrink-0 bg-webiify-blue/10 rounded-full p-3 animate-pulse">
                ...
                <div className="flex items-start space-x-4 animate-fade-in animate-delay-400 hover:translate-x-2 transition-transform duration-300">
                  <div className="flex-shrink-0 bg-webiify-green/10 rounded-full p-3 animate-pulse">
              ...
              <div className="animate-fade-in animate-delay-500">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 dark:bg-gray-800 hover:bg-webiify-blue hover:text-white dark:hover:bg-webiify-blue transition-colors p-3 rounded-full hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 animate-slide-in-right animate-delay-100 transform hover:shadow-2xl transition-all duration-500">
              <h3 className="text-xl font-bold mb-6 animate-fade-in">Send Us a Message</h3>
              <form>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div className="animate-fade-in animate-delay-200">
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-webiify-blue transition-all duration-300 hover:border-webiify-blue"
                ...
                <Button variant="default" className="w-full bg-gradient-to-r from-webiify-blue to-webiify-purple text-white animate-pulse hover:animate-none" size="lg">
                  Send Message
                </Button>
              </form>
            </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="rounded-xl overflow-hidden shadow-lg h-96 animate-fade-in transform hover:shadow-2xl transition-all duration-500">
            <iframe
